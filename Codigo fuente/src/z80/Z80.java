...
static boolean DEBUG = false; 
 ...
 public final void exec(int cycles) 
 {
  ...
  while (cycle > 0)
  {
	  ...
	  if (state_HALT == true)
	  {
	   ...
	   if (DEBUG) debug(instruction, PPC, PC, A, F, B, C, D, E, H, L, SP, IX, IY, I, cycle);
	  }	
 }	
 ...
 private final void prefix_ED() {
	 ...
	 switch (instruction & 0xff) {
	  ...
	  default: error(instruction, PPC); break; 
	 }
 }
...
/** $CB prefix opcodes */
 ...
 private final int execXY(int XY) {
	...
	switch (instruction&0xff) {
		...
		case 0x06 :
		case 0x07 :
		case 0x08 : error(instruction, PPC); break;
		...
		case 0x16 :
		case 0x17 :
		case 0x18 : error(instruction, PPC); break; 
		...
		case 0x1e :
		case 0x1f :
		case 0x20 : error(instruction, PPC); break;
		...
		case 0x24 :
		case 0x25 : error(instruction, PPC); break; 
		case 0x26 : cycle-=11; XY=(XY&0x00ff)|(peekb(PC++)<<8); break;		// LD HXY,n		ok
		case 0x27 :
		case 0x28 : error(instruction, PPC); break;
		...
		case 0x31 :
		case 0x32 :
		case 0x33 : error(instruction, PPC); break; 
		...
		case 0x37 :
		case 0x38 : error(instruction, PPC); break; 
		...
		case 0x43 :
		case 0x44 :
		case 0x45 : error(instruction, PPC); break; 
		case 0x46 :	cycle-=11; B=peekb(IXYd); PC++; break; 						// LD B,(XY+d)	ok
		case 0x47 :
		case 0x48 :
		case 0x49 :
		case 0x4a :
		case 0x4b : error(instruction, PPC); break; 
		...
		case 0x51 :
		case 0x52 :
		case 0x53 : error(instruction, PPC); break; 
		...
		case 0x64 :
		case 0x65 : error(instruction, PPC); break; 
		...
		case 0x6c :
		case 0x6d : error(instruction, PPC); break; 
		...
		case 0x79 :
		case 0x7a :
		case 0x7b : error(instruction, PPC); break;
		...
		case 0x81 :
		case 0x82 :
		case 0x83 : error(instruction, PPC); break; 
		...
		case 0x8b :
		case 0x8c :
		case 0x8d : error(instruction, PPC); break; 
		case 0x8e :	cycle-= 11; A=adcA_8(peekb(IXYd),A); PC++; break; 		// ADC A,(XY+d)	ok
		case 0x8f :
		case 0x90 :
		case 0x91 :
		case 0x92 :
		case 0x93 : error(instruction, PPC); break; 
		...
		case 0x9b :
		case 0x9c :
		case 0x9d : error(instruction, PPC); break; 
		...
		case 0xa3 :
		case 0xa4 :
		case 0xa5 : error(instruction, PPC); break; 
		case 0xa6 :	cycle-=11; A=andA(peekb(IXYd),A); PC++; break; 			// AND (XY+d)	ok
		case 0xa7 :
		case 0xa8 :
		case 0xa9 :
		case 0xaa :
		case 0xab : error(instruction, PPC); break; 
		case 0xac : cycle-=11; A=xorA(XY>>8,A); break;
		case 0xad : error(instruction, PPC); break;
		...
		case 0xb3 :
		case 0xb4 :
		case 0xb5 : error(instruction, PPC); break; 
		...
		case 0xbb :
		case 0xbc :
		case 0xbd : error(instruction, PPC); break; 
		...
		case 0xcb :	
					...
					break;
		case 0xe1:	cycle-=14; XY=pop(); break; 					
		case 0xe3:	cycle-=23; tmp1=peekw(SP);pokew(SP,XY);XY=tmp1; break; 	
		case 0xe5:	cycle-=14; pokew(SP-2,XY); SP-=2; break; 		
		case 0xe9:	cycle-= 8; PC=XY; break; 				
		case 0xeb:	cycle-= 8; tmp1=DE(); D=XY>>8; E=XY&0xff; XY=tmp1; break; 	
		case 0xf9:	cycle-=10; SP=XY; break; 				
 ...
 */
 ...
 public void debug(int instruction, int PPC,int PC, int A, int F, int B, int C, int D, int E,
